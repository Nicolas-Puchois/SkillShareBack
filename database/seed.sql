/* ------------------------------------------------------------------
   FAKE DATA – SKILLSHAREDB
   ------------------------------------------------------------------ */

-- ➡️  Utilisateurs
INSERT INTO `user` (username, avatar, email, password, created_at) VALUES
...
( 'Frederic',   'Frederique.png',   'Frederique@example.com',  '$2y$10$2RWot3AW6eFNeRXKDfZNAuqZHu8y/RzFExt2yD0dku/.i1upXbDWG', '2025-02-11 18:20:00'),
( 'Jonathan',    'Jonhathan.jpg',    'Jonhathan@example.com',   '$2y$10$2RWot3AW6eFNeRXKDfZNAuqZHu8y/RzFExt2yD0dku/.i1upXbDWG', '2025-03-01 08:42:00'),
